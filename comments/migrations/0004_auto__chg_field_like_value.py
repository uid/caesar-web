...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Like.value'
        db.alter_column('comments_like', 'value', self.gf('django.db.models.fields.SmallIntegerField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'Like.value'
        db.alter_column('comments_like', 'value', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        'comments.comment': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'child_comments'", 'null': 'True', 'to': "orm['comments.Comment']"}),
            'start': ('django.db.models.fields.IntegerField', [], {}),
