...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('comments', ['Star'])


    def backwards(self, orm):
        
        # Deleting model 'Star'
        db.delete_table('comments_star')
    ...
    models = {
        ...
        'comments.vote': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': "orm['comments.Comment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
