...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('review_task', ['chunk_id', 'reviewer_id'])
        db.rename_table('review_task', 'tasks_task')
    ...
    def backwards(self, orm):
        ...
        db.rename_table('tasks_task', 'review_task')
        # Adding unique constraint on 'Task', fields ['chunk', 'reviewer']
        db.create_unique('review_task', ['chunk_id', 'reviewer_id'])
