...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.chunk'
        db.alter_column('tasks_task', 'chunk_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['chunks.Chunk']))
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'chunk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks'", 'null': 'True', 'to': "orm['chunks.Chunk']"}),
