...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tasks_task', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, related_name='tasks', to=orm['chunks.ReviewMilestone']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.milestone'
        db.delete_column('tasks_task', 'milestone_id')
