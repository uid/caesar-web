...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.reviewer_user'
        db.add_column(u'tasks_task', 'reviewer_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='tasks', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.reviewer_user'
        db.delete_column(u'tasks_task', 'reviewer_user_id')
