...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submissions_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('submission', models.ForeignKey(orm['chunks.submission'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique(u'submissions_authors', ['submission_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field authors on 'Submission'
        db.delete_table('submissions_authors')
