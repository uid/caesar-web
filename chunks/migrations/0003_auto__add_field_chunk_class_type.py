...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chunk.class_type'
        db.add_column(u'chunks', 'class_type', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chunk.class_type'
        db.delete_column(u'chunks', 'class_type')
