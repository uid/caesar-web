...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewMilestone.chunks_to_exclude'
        db.add_column(u'chunks_reviewmilestone', 'chunks_to_exclude',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewMilestone.chunks_to_exclude'
        db.delete_column(u'chunks_reviewmilestone', 'chunks_to_exclude')
    ...
    models = {
        ...
        u'chunks.staffmarker': {
            'Meta': {'object_name': 'StaffMarker'},
            'chunk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'staffmarkers'", 'to': u"orm['chunks.Chunk']"}),
