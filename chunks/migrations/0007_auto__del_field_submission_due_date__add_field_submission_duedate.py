...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Submission.due_date'
        db.delete_column(u'submissions', 'due_date')

        # Adding field 'Submission.duedate'
        db.add_column(u'submissions', 'duedate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Submission.due_date'
        db.add_column(u'submissions', 'due_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
