...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Batch.assignment'
        db.delete_column('chunks_batch', 'assignment_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Batch.assignment'
        raise RuntimeError("Cannot reverse this migration. 'Batch.assignment' and its values cannot be restored.")
