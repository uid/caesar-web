...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChunkProfile.static_comments'
        db.add_column('chunks_chunkprofile', 'static_comments', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChunkProfile.static_comments'
        db.delete_column('chunks_chunkprofile', 'static_comments')
