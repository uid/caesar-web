...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChunkProfile.valid'
        db.add_column('chunks_chunkprofile', 'valid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChunkProfile.viable_comments'
        db.add_column('chunks_chunkprofile', 'viable_comments', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChunkProfile.valid'
        db.delete_column('chunks_chunkprofile', 'valid')

        # Deleting field 'ChunkProfile.viable_comments'
        db.delete_column('chunks_chunkprofile', 'viable_comments')
