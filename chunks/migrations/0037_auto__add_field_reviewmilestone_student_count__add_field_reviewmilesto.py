...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReviewMilestone.student_count'
        db.add_column('chunks_reviewmilestone', 'student_count',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding field 'ReviewMilestone.student_count_default'
        db.add_column('chunks_reviewmilestone', 'student_count_default',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding field 'ReviewMilestone.alum_count'
        db.add_column('chunks_reviewmilestone', 'alum_count',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)

        # Adding field 'ReviewMilestone.alum_count_default'
        db.add_column('chunks_reviewmilestone', 'alum_count_default',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)

        # Adding field 'ReviewMilestone.staff_count'
        db.add_column('chunks_reviewmilestone', 'staff_count',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'ReviewMilestone.staff_count_default'
        db.add_column('chunks_reviewmilestone', 'staff_count_default',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)

        # Adding field 'ReviewMilestone.students'
        db.add_column('chunks_reviewmilestone', 'students',
                      self.gf('django.db.models.fields.IntegerField')(default=199),
                      keep_default=False)

        # Adding field 'ReviewMilestone.students_default'
        db.add_column('chunks_reviewmilestone', 'students_default',
                      self.gf('django.db.models.fields.IntegerField')(default=199),
                      keep_default=False)

        # Adding field 'ReviewMilestone.alums'
        db.add_column('chunks_reviewmilestone', 'alums',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ReviewMilestone.alums_default'
        db.add_column('chunks_reviewmilestone', 'alums_default',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ReviewMilestone.staff'
        db.add_column('chunks_reviewmilestone', 'staff',
                      self.gf('django.db.models.fields.IntegerField')(default=15),
                      keep_default=False)

        # Adding field 'ReviewMilestone.staff_default'
        db.add_column('chunks_reviewmilestone', 'staff_default',
                      self.gf('django.db.models.fields.IntegerField')(default=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReviewMilestone.student_count'
        db.delete_column('chunks_reviewmilestone', 'student_count')

        # Deleting field 'ReviewMilestone.student_count_default'
        db.delete_column('chunks_reviewmilestone', 'student_count_default')

        # Deleting field 'ReviewMilestone.alum_count'
        db.delete_column('chunks_reviewmilestone', 'alum_count')

        # Deleting field 'ReviewMilestone.alum_count_default'
        db.delete_column('chunks_reviewmilestone', 'alum_count_default')

        # Deleting field 'ReviewMilestone.staff_count'
        db.delete_column('chunks_reviewmilestone', 'staff_count')

        # Deleting field 'ReviewMilestone.staff_count_default'
        db.delete_column('chunks_reviewmilestone', 'staff_count_default')

        # Deleting field 'ReviewMilestone.students'
        db.delete_column('chunks_reviewmilestone', 'students')

        # Deleting field 'ReviewMilestone.students_default'
        db.delete_column('chunks_reviewmilestone', 'students_default')

        # Deleting field 'ReviewMilestone.alums'
        db.delete_column('chunks_reviewmilestone', 'alums')

        # Deleting field 'ReviewMilestone.alums_default'
        db.delete_column('chunks_reviewmilestone', 'alums_default')

        # Deleting field 'ReviewMilestone.staff'
        db.delete_column('chunks_reviewmilestone', 'staff')

        # Deleting field 'ReviewMilestone.staff_default'
        db.delete_column('chunks_reviewmilestone', 'staff_default')
