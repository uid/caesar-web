...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assignments', 'student_count', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Adding field 'Assignment.alum_count'
        db.add_column(u'assignments', 'alum_count', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'Assignment.staff_count'
        db.add_column(u'assignments', 'staff_count', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'Assignment.chunks_to_assign'
        db.add_column(u'assignments', 'chunks_to_assign', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
