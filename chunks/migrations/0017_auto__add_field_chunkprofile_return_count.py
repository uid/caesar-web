...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChunkProfile.return_count'
        db.add_column('chunks_chunkprofile', 'return_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChunkProfile.return_count'
        db.delete_column('chunks_chunkprofile', 'return_count')
