...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'submissions', 'assignment_id')

        # Deleting field 'Submission.duedate'
        db.delete_column(u'submissions', 'duedate')

        # Deleting field 'Assignment.multiplier'
        db.delete_column(u'assignments', 'multiplier')

        # Deleting field 'Assignment.min_student_lines'
        db.delete_column(u'assignments', 'min_student_lines')

        # Deleting field 'Assignment.chunks_to_assign'
        db.delete_column(u'assignments', 'chunks_to_assign')

        # Deleting field 'Assignment.max_extension'
        db.delete_column(u'assignments', 'max_extension')

        # Deleting field 'Assignment.code_review_end_date'
        db.delete_column(u'assignments', 'code_review_end_date')

        # Deleting field 'Assignment.created'
        db.delete_column(u'assignments', 'created')

        # Deleting field 'Assignment.duedate'
        db.delete_column(u'assignments', 'duedate')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Submission.assignment'
        raise RuntimeError("Cannot reverse this migration. 'Submission.assignment' and its values cannot be restored.")
        # Adding field 'Submission.duedate'
        db.add_column(u'submissions', 'duedate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assignment.multiplier'
        db.add_column(u'assignments', 'multiplier',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Assignment.min_student_lines'
        db.add_column(u'assignments', 'min_student_lines',
                      self.gf('django.db.models.fields.IntegerField')(default=30),
                      keep_default=False)

        # Adding field 'Assignment.chunks_to_assign'
        db.add_column(u'assignments', 'chunks_to_assign',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assignment.max_extension'
        db.add_column(u'assignments', 'max_extension',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Assignment.code_review_end_date'
        db.add_column(u'assignments', 'code_review_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Assignment.duedate'
        db.add_column(u'assignments', 'duedate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assignment.reviewers_per_chunk'
        db.add_column(u'assignments', 'reviewers_per_chunk',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)
