...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Batch.is_live'
        db.delete_column('chunks_batch', 'is_live')

        # Deleting field 'Assignment.is_live'
        db.delete_column(u'assignments', 'is_live')


    def backwards(self, orm):
        # Adding field 'Batch.is_live'
        db.add_column('chunks_batch', 'is_live',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Assignment.is_live'
        db.add_column(u'assignments', 'is_live',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
