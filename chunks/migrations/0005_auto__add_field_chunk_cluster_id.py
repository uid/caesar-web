...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chunk.cluster_id'
        db.add_column(u'chunks', 'cluster_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chunk.cluster_id'
        db.delete_column(u'chunks', 'cluster_id')
