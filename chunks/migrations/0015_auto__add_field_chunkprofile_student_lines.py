...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChunkProfile.student_lines'
        db.add_column('chunks_chunkprofile', 'student_lines', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChunkProfile.student_lines'
        db.delete_column('chunks_chunkprofile', 'student_lines')
