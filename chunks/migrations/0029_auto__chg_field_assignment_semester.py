...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Assignment.semester' to match new field type.
        db.rename_column(u'assignments', 'semester', 'semester_id')
        # Changing field 'Assignment.semester'
        db.alter_column(u'assignments', 'semester_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['chunks.Semester']))
        # Adding index on 'Assignment', fields ['semester']
        db.create_index(u'assignments', ['semester_id'])


    def backwards(self, orm):
        # Removing index on 'Assignment', fields ['semester']
        db.delete_index(u'assignments', ['semester_id'])


        # Renaming column for 'Assignment.semester' to match new field type.
        db.rename_column(u'assignments', 'semester_id', 'semester')
        # Changing field 'Assignment.semester'
        db.alter_column(u'assignments', 'semester', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
