...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chunks_chunkprofile', (
            ...
            ('chunk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='profiles', to=orm['chunks.Chunk'])),
            ('semicolons', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
