...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.revision'
        db.add_column(u'submissions', 'revision', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Submission.revision_date'
        db.add_column(u'submissions', 'revision_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.revision'
        db.delete_column(u'submissions', 'revision')

        # Deleting field 'Submission.revision_date'
        db.delete_column(u'submissions', 'revision_date')
