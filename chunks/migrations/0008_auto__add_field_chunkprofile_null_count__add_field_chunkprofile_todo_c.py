...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChunkProfile.isntanceof_count'
        db.add_column('chunks_chunkprofile', 'isntanceof_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'ChunkProfile.synchronized_count'
        db.add_column('chunks_chunkprofile', 'synchronized_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ChunkProfile.isntanceof_count'
        db.delete_column('chunks_chunkprofile', 'isntanceof_count')

        # Deleting field 'ChunkProfile.synchronized_count'
        db.delete_column('chunks_chunkprofile', 'synchronized_count')
    ...
    models = {
        ...
        'chunks.chunkprofile': {
            ...
            'chunk': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'profiles'", 'to': "orm['chunks.Chunk']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isntanceof_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
