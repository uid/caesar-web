...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ChunkProfile'
        db.delete_table('chunks_chunkprofile')

        # Adding field 'Chunk.student_lines'
        db.add_column(u'chunks', 'student_lines',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Chunk.chunk_info'
        db.add_column(u'chunks', 'chunk_info',
    ...
    def backwards(self, orm):
        ...
        # Adding model 'ChunkProfile'
        db.create_table('chunks_chunkprofile', (
            ('return_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('chunk', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['chunks.Chunk'])),
            ('static_comments', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('if_nesting_depth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('comment_words', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('viable_comments', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('for_nesting_depth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('student_lines', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('synchronized_count', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('chunks', ['ChunkProfile'])

        # Deleting field 'Chunk.student_lines'
        db.delete_column(u'chunks', 'student_lines')

        # Deleting field 'Chunk.chunk_info'
        db.delete_column(u'chunks', 'chunk_info')
