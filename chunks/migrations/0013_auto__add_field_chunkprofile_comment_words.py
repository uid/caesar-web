...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChunkProfile.comment_words'
        db.add_column('chunks_chunkprofile', 'comment_words', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChunkProfile.comment_words'
        db.delete_column('chunks_chunkprofile', 'comment_words')
