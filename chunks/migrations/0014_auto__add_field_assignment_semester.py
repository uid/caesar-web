...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assignment.semester'
        db.add_column(u'assignments', 'semester', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.semester'
        db.delete_column(u'assignments', 'semester')
