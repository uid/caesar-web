...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'submissions', 'status', self.gf('django.db.models.fields.CharField')(default='A', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.status'
        db.delete_column(u'submissions', 'status')
