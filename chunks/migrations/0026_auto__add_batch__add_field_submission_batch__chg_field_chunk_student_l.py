...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Batch'
        db.create_table('chunks_batch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='batches', to=orm['chunks.Assignment'])),
        ))
        db.send_create_signal('chunks', ['Batch'])

        # Adding field 'Submission.batch'
        db.add_column(u'submissions', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='submissions', null=True, to=orm['chunks.Batch']),
                      keep_default=False)


        # Changing field 'Chunk.student_lines'
        db.alter_column(u'chunks', 'student_lines', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting model 'Batch'
        db.delete_table('chunks_batch')

        # Deleting field 'Submission.batch'
        db.delete_column(u'submissions', 'batch_id')


        # Changing field 'Chunk.student_lines'
        db.alter_column(u'chunks', 'student_lines', self.gf('django.db.models.fields.IntegerField')(null=True))
