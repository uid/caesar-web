...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.description'
        db.add_column('chunks_semester', 'description',
        ...
        db.add_column('chunks_semester', 'about_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.description'
        db.delete_column('chunks_semester', 'description')

        # Deleting field 'Semester.about'
        db.delete_column('chunks_semester', 'about')

        # Deleting field 'Semester.about_html'
        db.delete_column('chunks_semester', 'about_html')
