...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assignments', 'student_count_default', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Adding field 'Assignment.alum_count_default'
        db.add_column(u'assignments', 'alum_count_default', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'Assignment.staff_count_default'
        db.add_column(u'assignments', 'staff_count_default', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'Assignment.students_default'
        db.add_column(u'assignments', 'students_default', self.gf('django.db.models.fields.IntegerField')(default=199), keep_default=False)

        # Adding field 'Assignment.alums_default'
        db.add_column(u'assignments', 'alums_default', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Assignment.staff_default'
        db.add_column(u'assignments', 'staff_default', self.gf('django.db.models.fields.IntegerField')(default=15), keep_default=False)
