...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'assignments', 'students', self.gf('django.db.models.fields.IntegerField')(default=199), keep_default=False)

        # Adding field 'Assignment.alums'
        db.add_column(u'assignments', 'alums', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Assignment.staff'
        db.add_column(u'assignments', 'staff', self.gf('django.db.models.fields.IntegerField')(default=15), keep_default=False)
