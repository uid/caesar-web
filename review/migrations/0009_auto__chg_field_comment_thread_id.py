...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.thread_id'
        db.alter_column('review_comment', 'thread_id', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Comment.thread_id'
        raise RuntimeError("Cannot reverse this migration. 'Comment.thread_id' and its values cannot be restored.")
