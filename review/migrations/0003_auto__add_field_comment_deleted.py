...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('review_comment', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.deleted'
        db.delete_column('review_comment', 'deleted')
