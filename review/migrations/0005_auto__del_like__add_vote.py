...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Like'
        db.delete_table('comments_like')

        # Adding model 'Vote'
        db.create_table('comments_vote', (
        ...
        db.send_create_signal('comments', ['Vote'])
    
    
    def backwards(self, orm):
        
        # Adding model 'Like'
        db.create_table('comments_like', (
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('comments', ['Like'])

        # Deleting model 'Vote'
        db.delete_table('comments_vote')
