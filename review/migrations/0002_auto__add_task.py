...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Task'
        db.create_table('review_task', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('chunk', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', to=orm['chunks.Chunk'])),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', to=orm['accounts.UserProfile'])),
            ('due', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='N', max_length=1)),
        ))
        db.send_create_signal('review', ['Task'])


    def backwards(self, orm):
        
        # Deleting model 'Task'
        db.delete_table('review_task')
