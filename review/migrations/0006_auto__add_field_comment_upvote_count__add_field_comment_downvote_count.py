...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.upvote_count'
        db.add_column('review_comment', 'upvote_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Comment.downvote_count'
        db.add_column('review_comment', 'downvote_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.upvote_count'
        db.delete_column('review_comment', 'upvote_count')

        # Deleting field 'Comment.downvote_count'
        db.delete_column('review_comment', 'downvote_count')
