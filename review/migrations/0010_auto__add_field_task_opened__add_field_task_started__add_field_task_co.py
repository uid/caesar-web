...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.opened'
        db.add_column('review_task', 'opened', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.started'
        db.add_column('review_task', 'started', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.completed'
        db.add_column('review_task', 'completed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.opened'
        db.delete_column('review_task', 'opened')

        # Deleting field 'Task.started'
        db.delete_column('review_task', 'started')

        # Deleting field 'Task.completed'
        db.delete_column('review_task', 'completed')


    models = {
        'accounts.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'assigned_chunks': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'reviewers'", 'symmetrical': 'False', 'through': "orm['review.Task']", 'to': "orm['chunks.Chunk']"}),
