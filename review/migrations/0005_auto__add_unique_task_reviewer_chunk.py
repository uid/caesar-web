...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Task', fields ['reviewer', 'chunk']
        db.create_unique('review_task', ['reviewer_id', 'chunk_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Task', fields ['reviewer', 'chunk']
        db.delete_unique('review_task', ['reviewer_id', 'chunk_id'])
