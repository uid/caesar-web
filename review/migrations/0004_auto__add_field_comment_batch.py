...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.batch'
        db.add_column('review_comment', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['chunks.Batch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.batch'
        db.delete_column('review_comment', 'batch_id')
    ...
    models = {
        ...
        'review.comment': {
            ...
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comments'", 'null': 'True', 'to': "orm['chunks.Batch']"}),
