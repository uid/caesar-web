...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('review_vote', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 6, 20, 22, 5, 44, 522841), blank=True), keep_default=False)

        # Adding field 'Vote.modified'
        db.add_column('review_vote', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 6, 20, 22, 5, 54, 172876), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.created'
        db.delete_column('review_vote', 'created')

        # Deleting field 'Vote.modified'
        db.delete_column('review_vote', 'modified')
