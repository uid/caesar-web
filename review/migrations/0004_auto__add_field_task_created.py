...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('review_task', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 6, 7, 15, 8, 42, 132924), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.created'
        db.delete_column('review_task', 'created')
