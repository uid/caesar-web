...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tasks_task', (
            ...
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tasks', null=True, to=orm['chunks.Submission'])),
            ('chunk', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tasks', null=True, to=orm['chunks.Chunk'])),
            ('chunk_review', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tasks', null=True, to=orm['review.ChunkReview'])),
        ...
        db.send_create_signal(u'review', ['Task'])

        # Adding unique constraint on 'Task', fields ['chunk', 'reviewer']
        db.create_unique('tasks_task', ['chunk_id', 'reviewer_id'])

        # Adding model 'ChunkReview'
        db.create_table('tasks_chunkreview', (
        ...
        db.send_create_signal(u'review', ['ChunkReview'])


    def backwards(self, orm):
        # moved these models back to tasks app; don't actually delete them
        # # Removing unique constraint on 'Task', fields ['chunk', 'reviewer']
        # db.delete_unique('tasks_task', ['chunk_id', 'reviewer_id'])

        # # Deleting model 'Task'
        # db.delete_table('tasks_task')

        # # Deleting model 'ChunkReview'
        # db.delete_table('tasks_chunkreview')
        pass
