...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.similar_comment'
        db.add_column(u'review_comment', 'similar_comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='similar_comments', null=True, to=orm['review.Comment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.similar_comment'
        db.delete_column(u'review_comment', 'similar_comment_id')
