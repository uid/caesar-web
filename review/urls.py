...
urlpatterns = patterns('',
    ...
    (r'^simulate/(?P<review_milestone_id>\d+)', 'review.views.simulate'),
    (r'^list_users/(?P<review_milestone_id>\d+)', 'review.views.list_users'),
    (r'^load_similar_comments/(?P<chunk_id>\d+)/(?P<load_all_staff_comments>(True|False))', 'review.views.load_similar_comments'),
    (r'^highlight_comment_chunk_line/(?P<comment_id>\d+)', 'review.views.highlight_comment_chunk_line'),
    ...
    (r'^registration/complete/$', TemplateView.as_view(template_name='registration_request_complete.html')),
