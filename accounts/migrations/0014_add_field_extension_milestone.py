...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("chunks", "0033_migrate_to_milestones"),
    )

    def forwards(self, orm):
        # Adding field 'Extension.milestone'
        db.add_column('accounts_extension', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, related_name='extensions', to=orm['chunks.Milestone']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Extension.milestone'
        db.delete_column('accounts_extension', 'milestone_id')
