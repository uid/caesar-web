...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_extension')

        # Adding field 'UserProfile.extension_days'
        db.add_column('accounts_userprofile', 'extension_days',
