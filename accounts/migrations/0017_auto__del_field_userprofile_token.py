...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'token_id')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.token'
        db.add_column('accounts_userprofile', 'token', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='invited', null=True, to=orm['accounts.Token']), keep_default=False)
