...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.extension_days'
        db.add_column('accounts_userprofile', 'extension_days', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.extension_days'
        db.delete_column('accounts_userprofile', 'extension_days')
