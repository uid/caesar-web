...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.role'
        db.alter_column(u'accounts_member', 'role', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Member.role'
        db.alter_column(u'accounts_member', 'role', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        ...
        u'chunks.reviewmilestone': {
            ...
            'submit_milestone': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'review_milestones'", 'to': u"orm['chunks.SubmitMilestone']"})
        },
        u'chunks.semester': {
