...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.reputation'
        db.add_column('accounts_userprofile', 'reputation', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.reputation'
        db.delete_column('accounts_userprofile', 'reputation')
