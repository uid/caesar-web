...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.semester_taken'
        db.add_column('accounts_userprofile', 'semester_taken', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.semester_taken'
        db.delete_column('accounts_userprofile', 'semester_taken')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'extension_days': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
