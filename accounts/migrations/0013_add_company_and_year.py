...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'company',
                      self.gf('django.db.models.fields.CharField')(default='MIT', max_length=100),
                      keep_default=False)

        # Adding field 'UserProfile.class_year'
        db.add_column('accounts_userprofile', 'class_year',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'company')

        # Deleting field 'UserProfile.class_year'
        db.delete_column('accounts_userprofile', 'class_year')
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'class_year': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'company': ('django.db.models.fields.CharField', [], {'default': "'MIT'", 'max_length': '100'}),
