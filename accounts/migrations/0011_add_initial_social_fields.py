...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'twitter')

        # Deleting field 'UserProfile.github'
        db.delete_column('accounts_userprofile', 'github')

        # Deleting field 'UserProfile.linkedin'
        db.delete_column('accounts_userprofile', 'linkedin')
