...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'about')

        # Deleting field 'UserProfile.about_html'
        db.delete_column('accounts_userprofile', 'about_html')
