...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CommentSearchLog.comment'
        db.add_column(u'userlogging_commentsearchlog', 'comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='comment_search_log', to=orm['review.Comment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CommentSearchLog.comment'
        db.delete_column(u'userlogging_commentsearchlog', 'comment_id')
    ...
    models = {
        ...
        u'userlogging.commentsearchlog': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'comment_search_log'", 'to': u"orm['review.Comment']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
